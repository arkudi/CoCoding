...
const running: Run = {
  ...
  finished_at: null, messages: [], tool_calls: [], file_changes: [], agent_executions: [], agent_tasks: [],
}
...
const completed: Run = {
  ...
  created_at: '2026-09-01T00:00:00Z', updated_at: '2026-09-01T00:00:01Z',
  finished_at: '2026-09-01T00:00:01Z', messages: [], tool_calls: [], file_changes: [], agent_executions: [], agent_tasks: [],
}
